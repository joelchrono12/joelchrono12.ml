...
Earlier today as I checked my RSS reader I read this update from [Steve](https://lwgrs.bearblog.dev/quick-update-two-sentence-journal/), who wrote:

> Last week I wrote about the two-sentence journal method, which I was generally optimistic about using.

I actually shared a link to this "two-sentence" journaling method in my [last weeknotes](/blog/2025-w41/#around-the-web), so that's fun. Anyway, the next paragraph starts with:

> Well...I really haven't been using it. 

So, I think, *that's literally me!*

Then on the fediverse I saw another post from Matt about how [buying a Steam Deck didn't pay off for him](https://mtwb.blog/posts/2025/the-steamdeck-wassnt-a-good-purchase/), because he doesn't even play videogames much, and he says:
...
I've written a few posts about some of the issues I've been dealing with---which in the grand scheme of things aren't really a big deal, I guess---such as:
 ...
 - [trying to buy less games](/blog/games-to-beat-before-buying-more/)---something I've failed at spectacularly.
 - [going to the gym more often](/blog/going-to-the-gym/)---with really mixed and unpredictable results, and
 - [eating less snacks](/blog/i-have-a-problem-with-snacks/)---which hasn't really worked out, as I've barely lowered my intake.
