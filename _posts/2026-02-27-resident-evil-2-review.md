...
image: "assets/img/blogs/2026-02-27-re2.webp"
---

A few days ago I wrote about how I recently decide to just [poke away at games](/blog/just-poking-away-at-videogames/) without actually feeling any rush to focus on a single game completely. But of course, sometimes a game just grips me from beginning to end, and I have to commit, because it's just that cool.
...
*Resident Evil 2* was picked for February in the Low Key Game Club from the [TWG Discord](https://discord.com/invite/xQ7ht3V)---which is also the reason I played [Jet Lancer](/blog/jet-lancer/) and [Soul Reaver](/blog/legacy-of-kain-soul-reaver/)---and for some reason it just felt like the perfect time to actually play this title and survive through Raccoon City myself.

![Resident Evil 2 artwork](/assets/img/blogs/2026-02-27-re2.webp)
...
{% include img.html caption='Leon makes it to the Police Station, the main location of the game.' image='/assets/img/blogs/2026-02-27-re2-1.webp' %}

## Gameplay

The gameplay that makes the original trilogy so special---and controversial among new players who want to get into them---are the [tank controls](https://en.wikipedia.org/wiki/Tank_controls) and the fixed camera angles. These two features limit both movement and vision, and while they can be hard to get used to at first, they are essential to the original experience, and they don't really take much effort to understand, after half and hour or so of playtime.

This is the franchise that coined the term [survival horror](https://en.wikipedia.org/wiki/Survival_horror), and these limitations and lack of agency challenge the player as they try to survive and explore the environments of the game. The limited ammo and items you can carry with you, means you'll have to be strategic about the path you follow as you try to make progress.
...
All of the Police Station is a giant escape room, and it is where the game shines most, as it is basically a sort of [Metroidvania](https://en.wikipedia.org/wiki/Metroidvania).
...
{% include img.html caption='The environment is done with prerrendered backgrounds, which allow greater detail, and more complex character models' image='/assets/img/blogs/2026-02-27-re2-2.webp' %}
...
{% include img.html caption='Leon and Claire find each other inside the police station' image='/assets/img/blogs/2026-02-27-re2-3.webp' %}
...
The game is currently on sale until March 3, 2026, excusively available for PC on [GOG](https://www.gog.com/en/game/resident_evil_2), you can even get the whole original trilogy there, in case you want to give them a go! I'll stick with my emulation handhelds though.
...
The game holds up and is perfectly playable today, and very close to taking a position in my personal [Top 25 Games](/blog/top-25-games-of-all-time/), something I didn't expect to happen so quickly, especially with a title I had abandoned before. Highly recommended!
