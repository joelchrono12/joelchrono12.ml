...
description: Here's my review for one of the most praised indie games and Metroidvanias of all time!
tags: game review
permalink: /blog/hollow-knight/
layout: post
date: 2025-09-03 20:12:08 -0600
host: fosstodon.org
username: joel
...
This is one of those modern games that I thought weren't really that big of a deal. I wasn't much into gaming other than whatever ran on my PSP. For a while I was happy with emulating [Metroid Fusion](/blog/metroid-fusion/) and [Zero Mission](/blog/metroid-zero-mission/), but well, I thought it would be nice to get into some more modern games, so I decided to buy it on Steam, alongside *CrossCode* and *Axiom Verge*---two games I'm yet to properly play.

So, I played it on my laptop for a while, up to 9 hours of playtime, more or less. I even [used my PSP as a controller](/blog/trying-psp-as-pc-controller/) with it, and it worked well enough.

However, playing it on my laptop just didn't work that well for me, so I abandoned it in the end.

It wasn't until much later, that I finally bought my [Nintendo Switch](/blog/nintendo-switch/), and well, I finally felt like giving it a go! I started the game in November of 2024, and I finally beat it a couple days ago!

{%
include img.html
image='/assets/img/blogs/2025-09-03-hollow-knight.png'
caption='Official artwork of the game'
%}
...
{%
include img.html
image='/assets/img/blogs/2025-09-03-hollow-knight-1.png'
caption='Soul Master is one of the early bosses in the game, quite the challenging one, given its location'
%}
...
{%
include img.html
image='/assets/img/blogs/2025-09-03-hollow-knight-2.png'
caption='A part of the map of Hallownest, divided in many different sections, with a variety of biomes, enemies and locations'
%}
...
{%
include img.html
image='/assets/img/blogs/2025-09-03-hollow-knight-3.png'
caption='Stag is one of your recurring companions, as he will help you fast travel between Stag Stations in Hallownest'
%}
...
Compared to modern games, like [Metroid Dread](/blog/metroid-dread/) and [The Lost Crown](/blog/prince-of-persia-the-lost-crown/), and even some older titles in the genre, there are a few annoyances, and missing quality of life features that *Hollow Knight* doesn't have. For example: 
