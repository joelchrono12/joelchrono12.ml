---
title: Old PC Games on Cereal Boxes
header: Old PC Games on Cereal Boxes
description: I wrote about some of the CD-Roms that came with the cereal back in the 2000s. A true trip down memory lane that brought me back to my childhood days.
tags: gaming storytime nostalgia
permalink: /blog/pc-games-on-cereal-boxes/
layout: post
date: 2026-03-21 12:10:00 -0600
host: fosstodon.org
username: joel
com_id: 116268530222855763
---

I mentioned a bit of this a few years back in a post where I shared some [early computing memories](/blog/early-computing-memories/). At the time, I only recalled what the games were about, but I didn't remember the names or specific game mechanics.
...
I talked about this post idea to [Wouter](https://dosgame.club/@jefklak), and he immediately reminded me about his own post of a similar vein where he reminisced on [edutainment games from his childhood](https://brainbaking.com/post/2024/07/edutainment-games-of-my-childhood/), so there you go, check it out too once you are done, or before, since they are older games than mine. 😉
...
{% include img.html image='/assets/img/blogs/2026-03-21-superbike-racing.png' caption='A race is about to begin!' %}

[Check out this gameplay video](https://youtu.be/kTMIyprjgpA)---where I got the screenshot from---it really brought some memories back!
...
{% include img.html image='/assets/img/blogs/2026-03-20-pet-racer-screenshot.png' caption='This is definitely not Mario Kart' %}

[You can easily find gameplay of this one on YouTube](https://youtu.be/v_7qiIAvJ-k), but just play [Super Tux Kart](https://supertuxkart.net/Main_Page.html), honestly, although the music ain't too bad.
...
I'm kind of interested on giving this one a revisit, the game is [still available on Steam](https://store.steampowered.com/app/286750/Zoo_Empire/) and on sale right now. It will probably suck by today standards, but I will give it a go for nostalgia's sake.

Reviews say that the game will eventually crash, but it will be fun to just mess around for a bit.

{% include img.html image='/assets/img/blogs/2026-03-20-zoo-empire-screenshot.png' caption='The zoo is thriving! Screenshot from the Steam page'  %}

[Check some gameplay here!](https://youtu.be/WcOuZs5vnGw)---The music actually holds up so well and unlocked my nostalgia even more than the gameplay itself.
...
{% include img.html image='/assets/img/blogs/2026-03-21-my-amazing-human-body.png' caption='Main interface of the game, Skelly in the middle' %}

[Check some gameplay of it on YouTube](https://www.youtube.com/watch?v=ZSDh3LJYz8c)---I must admit I prefer the Spanish dub, even though it's not Latin Spanish, I just got used to the voice.
