...
The very early CGI of the [FMV](https://en.wikipedia.org/Full_Motion_Video/) may not be that scary today, *but* the audio design is still more than great. And the scene itself is well done.
...
{% include img.html image='/assets/img/blogs/2026-04-12-jill-makes-it-to-a-save-room.png' caption='Jill makes it to a save room, an item box seen in the background' %}
...
{% include img.html image='/assets/img/blogs/2026-04-12-the-hunter-makes-its-appearance.png' caption='The Hunter makes its appearance, approaching Jill menacingly' %}
...
{% include img.html image='/assets/img/blogs/2026-04-12-a-giant-snake-eager-to-attack-jill.png' caption='A giant snake eager to attack Jill' %}
...
As someone who grew up with **no nostalgia for these games**, who wasn't even aware they were games until 2015 or so and only knew of the franchise because of the [Milla Jovovich movies](https://en.wikipedia.org/wiki/Resident_Evil_(film_series))---which I didn't even get to watch because they were way too violent and my parents wouldn't allow me to---I am really starting to love this series more than I thought, slowly taking on my top 3 alongside Halo and Metroid.
...
By the way, make sure to play the PS1's *Final Director's Cut* romhack to get the best version possible of the game in emulation. Of course, you can also acquire it via [GOG](https://www.gog.com/en/game/resident_evil) or [Steam](https://store.steampowered.com/app/4249100/Resident_Evil_1996/)---but the latter is DRM protected.
