---
title: "RE: Reassess time spent enjoying luxury"
header: "RE: Reassess time spent enjoying luxury"
description: An interesting post that made me think about how I use the free times I have for myself.
tags: response lifestyle ramble
permalink: /blog/reassess-time-spent-enjoying-luxury/
layout: post
...
url='https://lwgrs.bearblog.dev/reassess-time-spent-enjoying-luxury/'
site_url='https://lwgrs.bearblog.dev/'
...
From writing longer blog posts (I always write my reviews at home where I can quickly access screenshots and the like), to spending time on a different project (like the Rockbox theme for the Innioasis Y1 which [I just published](https://codeberg.org/joelchrono/AdwaitaPod-Arcticons-rockbox-360p/releases)). 
