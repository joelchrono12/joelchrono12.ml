...
Videogames are one of the most creative art forms, they've been present in my life since I have a memory, in a variety of eras and platforms. Choosing across that many years has been kind of hard, but well, this is my attempt at it.

This is what came out of my memory back in 2024, just in case you want to know how my brain remembered games (yes, Breath of The Wild was that low). It is different from the final list, so it's not really a spoiler. Still, if you want a peek, serve yourself.

<details markdown=1>
<summary>List from memory in May 2024</summary>
1. Chrono Trigger
...
I've been meaning to return to working on this list for the whole year and, I guess I might as well get it over with.

This was kind of hard honestly, there are some games missing from my original selection that didn't make it for various reason. Some are just kind of obvious, like, I decided to not put Mario Kart 8 just for variety. And I also tried to avoid repeating franchises unless the entries were like, significantly different from each other. Anyway, let's get started.
...
{% include img.html
image='/assets/img/blogs/2025-08-29/minecraft.png'
alt='Official artwork from the game, Steve and Alex up a mountain with a dog and a pig'
%}

*Minecraft* has been with me throughout most of my life in contact with the internet.

What else do I need to say? Among the first proper computer games I played, on a friend's laptop somewhere in the US, was happy and had no idea what redstone (or most things) did. I recall playing the free edition on an old Galaxy Tab 2 my dad had, and getting some pirated versions on some of my phones back then.

Since then, I've bought the Java edition on my laptop and I play it from time to time, I think it is destined to be rediscovered by generations to come. 
...
{% include img.html
image='/assets/img/blogs/2025-08-29/starwars.png'
alt='Official artwork from the game, the secret apprentice force-pushing some storm troopers, while holding a red lightsaber'
%}

Given how many strong games are featured in the runner-up list, I felt a bit weird about having this one here. What is a random Star Wars game doing among the best of the best? Well, this is my list, and to me, this game is among the best I've ever completed (not that I've completed all the games here, mind you).

You are Darth Vader's secret apprentice, but end switching sides, and even help start the Rebel Alliance.

It's a hack and slash like the early God of War games, quick time events and all but not too annoying. You feel like the most powerful Force user in the galaxy. 

There's a lot of extras, fights from the movies and fun modes. These aren't found in the Xbox and Playstation versions. I spent hours trying in the Order 66 mode.

This game was the first game I had on my PSP. A fantastic showcase of the handheld's power, it blew me away as a kid. 
...
{% include img.html
image='/assets/img/blogs/2025-08-29/marioluigi.png'
alt='Official artwork from the game, a close up of Mario and Luigi surrounded by enemies, their expression ready for battle'
%}
...
This game starts how every Mario does, with Bowser attacking the castle about to kidnap Princes Peach, but then Peach's voice gets stolen by some witch, and off you go chasing after it to another kingdom. 

The highlight here's the combat system. It's turn-based, but you can enhance your attacks by hitting a button at the right time, as well as dodge attacks, by jumping or hitting an enemy back right before it hits you. And of course, dual combos between the brothers.
...
{% include img.html
image='/assets/img/blogs/2025-08-29/ysoath.png'
alt='Official artwork from the game, the three main characters posing, Adol ready for battle, Chester from afar and distant, Elena making eye-contact with the viewer'
%}
...
{% include img.html
image='/assets/img/blogs/2025-08-29/ysseven.png'
alt='Official artwork from the game, the Adol staring at the distance wearing armor, a variety of characters by his side in various poses'
%}
...
{% include img.html
image='/assets/img/blogs/2025-08-29/rr2.png'
alt='Official artwork from the game, a blue vehicle up-close'
%}

I always knew of this game, mentioned in videos about the best underrated PSP entries, alongside *Burnout Legends* and *Motorstorm Arctic's Edge*, and always thought how much better and fun those others looked. I was wrong.

Ridge Racer doesn't have fancy branded cars, or the best graphics, it doesn't even have damage---It has *drifting.*

That's it, that's all you are going to be doing in this game, and the physics behind it are quite simply, perfect. The sense of speed is superb, drifting your way through the same course with faster and faster vehicles, is completely different in practice.
...
Even though it's complicated at first, you get better, you master the tracks, and you are hooked.

## 19. Hades

{% include img.html
image='/assets/img/blogs/2025-08-29/hades.png'
alt='Official artwork from the game, Zagreus ready for battle, a Hydra in the background about to attack'
%}
...
I love this game, but I haven't finished it yet, I have managed to reach the surface a few times now, I just need some more to reach credits, and yeah, I know the real game will begin from there.

## 18. Castlevania: Aria of Sorrow

{% include img.html
image='/assets/img/blogs/2025-08-29/aria.png'
alt='Official artwork from the game, Soma Cruz face close-up, a white haired young looking man, holding a sword, gargoyles can be seen in the background'
%}

From here on out, Metroidvanias start showing up. Even if *Aria of Sorrow* is at the bottom of them, it's still fantastic.
...
{% include img.html
image='/assets/img/blogs/2025-08-29/fusion.png'
alt='Samus ready for battle walking through a dark passage-way, an enemy hanging on the ceiling can be seen in the background'
%}
...
The bosses are also quite the challenge though, but in modern times where save states exist, you really have no reason not to give this one a go. It's seriously fantastic.

One of the few games I have replayed more than once, it's just that good and quick to get into. Highly recommended!

## 16. Fire Emblem: The Blazing Blade

{% include img.html
image='/assets/img/blogs/2025-08-29/fe.png'
alt='To the left, the three main characters looking at something off screen, to the right, their descendants looking at the opposite direction'
%}
...
I don't know what you want me to say, you know Fire Emblem, you pick actions and move around in a grid and attack enemies and a sick animation plays and you win, unless you lose and that character dies forever, then you load a save state and try again.
...
{% include img.html
image='/assets/img/blogs/2025-08-29/minish.png'
alt='Link looking at something off-screen, Minish surround him and look at him curiously'
%}

This Zelda game is just awesome. It is a tight and doesn't take too long to beat. Every boss is great and it just looks wonderful. I wish the style used in this game was present in more games too.
...
This is one I haven't replayed in a while, I might have to give it go later this year? I won't promise anything though, but I have no doubts it will hold up really well.

## 14. Prince of Persia: The Lost Crown
{% include img.html
image='/assets/img/blogs/2025-08-29/pop.png'
...
{% include img.html
image='/assets/img/blogs/2025-08-29/celeste.png'
alt='Madeline trying to reach a winged strawberry up in the clouds'
%}
...
However, I've played enough to see all of what the game has to offer. The story and the setting is among the most ambitious of its time. And the mechanics are pretty good even today.
...
{% include img.html
image='/assets/img/blogs/2025-08-29/dqxi.png'
...
I just love how the plot is always moving forward, yes sometimes it's in a bit of a roundabout way, but it always ends up being worth the extra effort, precisely because the game goes beyond the tropes and actually has something to say, it's a story with a heart, and it can be felt throughout the whole experience. I still don't finish it, but I definitely will.

## 10. Hollow Knight

{% include img.html
image='/assets/img/blogs/2025-08-29/hk.png'
alt='The Knight surrounded resting alongside its nail'
%}

Compared to any RPG, Hollow Knight is a short game, but compared to any other Metroidvania, it's a massive undertaking. With only a few safe spots where you can save and recover health, it is also brutally difficult, it doesn't hold your hand at any point, and you will die, constantly, before you figure out how to move around properly and be decent at combat.
...
{% include img.html
image='/assets/img/blogs/2025-08-29/halo3.png'
alt='Master chief staring at the distance'
%}
...
I really can't believe there was a time when I did that, but it happened, and since the game remains among the best in the FPS genre. 

And the music, the soundtrack, it is simply outstanding, I listen to it almost every night as it is on my playlist of music to sleep to. Just play the whole trilogy already if you haven't. It's still super fun.
...
{% include img.html
image='/assets/img/blogs/2025-08-29/jeanne.png'
alt='Jeanne looking at the sky with eyes closed, probably thinking about the tragedy that is war or something'
%}
...
{% include img.html
image='/assets/img/blogs/2025-08-29/ffvi.png'
alt='Terra riding a mech, staring at a city. The game logo in the middle of everything'
%}
...
This game has been living rent-free in my head for the past 8 years or so at this point. I already told countless times the tale of how I had already played it almost to completion until I messed up, and my save file got lost to the void. It's almost an inside joke here.
...
The only problem is of course the random encounters, they really are a bit of a pain for those not used to turn-based combat. I personally don't mind at all during dungeons and when I'm just wandering around in the overworld, but when I just need to reach a place in the map and keep getting into battles, it hurts. And the caves, oof.
...
{% include img.html
image='/assets/img/blogs/2025-08-29/botw.png'
alt='Link climbing up a mountain, clouds in the background'
%}
...
Finding and completing shrines, sneaking around enemies, making use of the environment and really getting to know my way through pretty much everything the game has to offer, is one of the most satisfying gameplay loops I've experienced.

## 5. 1000xRESIST

{% include img.html
image='/assets/img/blogs/2025-08-29/1000.png'
alt='Watcher in front of a terrifying sight, motionless bodies floating in an gym, frozen in time, an orange light behind everything leaving only the shapes and no detail'
%}
...
{% include img.html
image='/assets/img/blogs/2025-08-29/time.png'
alt='Link riding Epona alongside Navy, in the background, the Hyrule field, the LonLon ranch and Death Mountain at the distance.'
%}
...
It wasn't until 2015 or 2016 that I just went back to it, and managed to complete the game! I even bought a PC controller, this time playing it on an old laptop I no longer have. 
...
{% include img.html
image='/assets/img/blogs/2025-08-29/dread.png'
...
{% include img.html
image='/assets/img/blogs/2025-08-29/mhfu.png'
alt='A hunter faces off against a Nargacuga in close combat'
%}

Quite simply, Monster Hunter Freedom Unite is a challenging game where you go after monsters, poke them until they die, and gather materials to build better armor and sticks. But of course, there's more to it than that.

This is one of the games I keep bringing up from time to time. I've talked a about playing this online with weird VPN programs and PPSSPP. Eventually better and more open tools, from OpenVPN to Zerotier or Tailscale emerged, and playing with other people is easier than ever.
...
{% include img.html
image='/assets/img/blogs/2025-08-29/chrono.png'
alt='Crono and friends posing, official character art'
%}
...
>
> --[Chrono Trigger is Thirty years old](/blog/chrono-trigger-is-thirty-years-old/)

In this game you embody Crono, a guy who goes to the fair to see her best friend's experiment, a teleporter! He stumbles into a girl in the way, and she ends up trying out the teleporting machine, until everything goes wrong, and she's lost in a sort of dimensional gate. Only you have the courage to go rescue her, and change the course of your own destiny!

There's not enough praise I can give to it. It's one of the few JRPGs I've ever replayed, it is one of the few I keep watching YouTube videos about after many years, countless essays, dozens of playthroughs, I just love Chrono Trigger, I love to know when people play it for the first time, I want to see everyone enjoying it, knowing about it. This is the game that changed the way I see videogames as a whole. This is why I think of videogames as art and not just entertainment. The reason I can see they can have a message, something to convey, something that sticks with you forever.


And Chrono Trigger's message is a beautiful one. The future is worth saving. Your comfort and easy going life is worth leaving, for the sake of those who haven't even been born yet. When you know what's coming and you know you can change it, it's at least worth a try. The world itself is crying for help, will you be up for the task?

## Final thoughts

So, what are your favorite games of all time?

Make sure to also see my individual [game reviews](/tags/game) for some of these titles, and you can always check my [weeknotes](/tags/weeknotes) and [monthly media summaries](/tags/monthly) to see general thoughts on each game I play!

I have so much more to say about some of these games, but it's also time to sleep so...

Tomorrow, just because I already wrote it but didn't want ot make this longer than it is, I will share some honorable mentions! Until next time.
